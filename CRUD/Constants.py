...
ApplesPos2A = MapInfo['layers'][14]['objecs']
...
WaterPosB = MapInfo['layer'][11]['objects']
Platforms2B = MapInfo['layer'][12]['objects']
VMovingPlatformS2B = MapInfo['layer'][13]['objects']
CoinsPos2B = MapInfo['layer'][14]['objects']
DiamondPos2B = MapInfo['layer'][15]['objects']
PotionsPos2B = MapInfo['layer'][16]['objects']
ApplesPos2B = MapInfo['layer'][17]['objects']
