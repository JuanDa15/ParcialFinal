...
def StartGame(j ,posx, posy):
    ...
    mapaa = pygame.image.load('Assets\Levels\Level2\Level2g.png')
    ...
    nom_archivo='Assets\Levels\Level2\Level2g.json'
    mapa_info = None
    ...
    while (True):
        ...
        if j.rect.right < 0:
            Room6.StartGame(j,Constants.Width, j.rect.y - 5)
