...
def StartGame(j ,posx, posy):
    ...
    mapaa = pygame.image.load('Assets\Levels\Level2\Level2f.png')
    ...
    nom_archivo='Assets\Levels\Level2\Level2f.json'
    mapa_info = None
        ...
        for j in jugadores:
            ...
            for j in jugadores:
                if j.rect.y >= Constants.Height + 10:
                    Room5.StartGame(j, j.rect.x, -5)


        if j.rect.left > Constants.Width:
            Room7.StartGame(j, 0, j.rect.y - 5)
