...
def StartGame(j ,posx, posy):
    ...
    mapaa = pygame.image.load('Assets\Levels\Level2\Level2h.png')
    ...
    nom_archivo='Assets\Levels\Level2\Level2h.json'
    mapa_info = None
    ...
    while (True):
        ...
        if j.rect.left > Constants.Width - 5:
            Room9.StartGame(j,-5, j.rect.y)
