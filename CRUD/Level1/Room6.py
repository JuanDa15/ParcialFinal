...
def StartGame(j,posx, posy):
    ...
    mapaa = pygame.image.load('Assets\Levels\Level1\Level1f.png')
    ...
    nom_archivo='Assets\Levels\Level1\Level1f.json'
    mapa_info = None
    ...
    Dicc_Plataformas= mapa_info['layers'][8]['objects']
    ...
    while (True):
        ...
        if j.rect.left > limitemovimiento:
            Room7.StartGame(j, 0, j.rect.y)

        if j.rect.right < 0:
            Room5.StartGame(j,limitemovimiento - 26, j.rect.y - 2)
